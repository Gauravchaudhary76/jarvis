...
def GoogleSearch(query):
    """This function performs a Google search and returns the results."""
    results = list(search(query, advanced=True, num_results=1))  # Only top result
...
def AnswerModifier(Answer):
    """This function modifies the answer by removing empty lines."""
    lines = Answer.split('\n')
